                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" name="transection_no" placeholder="Transection Number"
                                                value="{{ $transection_no }}" class="form-control" require>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-2">
                                            ...
                                            <textarea name="payment_descripiton" id="" cols="30" rows="2"
                                                class="form-control">{{ old('payment_descripiton') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-2">
                                            ...
                                            <textarea name="bill_to_address" id="" cols="30" rows="2"
                                                class="form-control">{{ old('bill_to_address') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" name="bill_to_phone" placeholder="Email"
                                                value="{{ old('bill_to_phone') }}" class="form-control" require>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="email" name="bill_to_email" placeholder="Email"
                                                value="{{ old('bill_to_email') }}" class="form-control" require>
                                        </div>
                                    </div>
                                </div>
