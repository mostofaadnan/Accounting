<div class="modal fade" id="customermodel" tabindex="-1" aria-labelledby="citymodal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <form action="{{ route('invoice.newcustomer') }}" method="post" enctype="multipart/form-data">
                        @csrf
